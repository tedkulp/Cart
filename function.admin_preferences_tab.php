...
$smarty->assign('formstart',$this->CGCreateFormStart($id,'admin_save_prefs'));
...
$smarty->assign('input_addtocart_destpage',
		$contentops->CreateHierarchyDropdown('',$this->GetPreference('addtocart_destpage'),
						     $id.'addtocart_destpage'));
